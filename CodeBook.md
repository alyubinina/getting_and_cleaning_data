...
4. Adding two columns with names "activity" and "subject" using data from files *y_train.txt*, *y_test.txt* and *subject_train.txt*, *subject_test.txt*  respectively.
